...
apt-get install -y --no-install-recommends \
  ...
  liblcms2-dev uuid-dev libexpat1-dev unifdef libwpe-1.0-dev libwpebackend-fdo-1.0-dev libgbm-dev libegl1-mesa-dev libgles2-mesa-dev meson libpsl-dev libnghttp2-dev
